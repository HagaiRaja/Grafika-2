...
void drawCanon(point center, color* c)
{
	...
	sudut5.y = center.y - 60;
	point sudut6;
	sudut6.x = center.x + 10;
	sudut6.y = center.y - 60;
...
void drawBullet(point center, color* c)
{
	...
	point sudut6;
	sudut6.x = center.x - 10;
	sudut6.y = center.y - 10;
	point sudut7;
	sudut7.x = center.x + 10;
	sudut7.y = center.y - 10;
	point sudut8;
	sudut8.x = center.x - 10;
	sudut8.y = center.y + 5;
	point sudut9;
	sudut9.x = center.x + 10;
	sudut9.y = center.y + 5;
	point sudut10;
	sudut10.x = center.x;
	sudut10.y = center.y + 10;

	drawLine(sudut1,sudut6,c);
	drawLine(sudut1,sudut7,c);
	drawLine(sudut2,sudut6,c);
	drawLine(sudut2,sudut8,c);
	drawLine(sudut3,sudut8,c);
	drawLine(sudut3,sudut10,c);
	drawLine(sudut4,sudut10,c);
	drawLine(sudut4,sudut9,c);
	drawLine(sudut5,sudut7,c);
	drawLine(sudut5,sudut9,c);
}
...
{
	point sudut1;
	sudut1.x = center.x - 120;
	sudut1.y = center.y - 10;
	point sudut2;
	sudut2.x = center.x - 120;
	sudut2.y = center.y + 10;
	point sudut3;
	sudut3.x = center.x - 100;
	sudut3.y = center.y - 25;
	point sudut4;
	sudut4.x = center.x - 100;
	sudut4.y = center.y + 25;
	point sudut5;
	sudut5.x = center.x - 45;
	sudut5.y = center.y - 25;
	point sudut6;
	sudut6.x = center.x - 15;
	sudut6.y = center.y - 90;
	point sudut7;
	sudut7.x = center.x + 15;
	sudut7.y = center.y - 90;
	point sudut8;
	sudut8.x = center.x - 15;
	sudut8.y = center.y - 25;
	point sudut9;
	sudut9.x = center.x - 45;
	sudut9.y = center.y + 25;
	point sudut10;
	sudut10.x = center.x - 15;
	sudut10.y = center.y + 90;
	point sudut11;
	sudut11.x = center.x + 15;
	sudut11.y = center.y + 90;
	point sudut12;
	sudut12.x = center.x - 15;
	sudut12.y = center.y + 25;
	point sudut13;
	sudut13.x = center.x + 90;
	sudut13.y = center.y - 25;
	point sudut14;
	sudut14.x = center.x + 120;
	sudut14.y = center.y - 60;
	point sudut15;
	sudut15.x = center.x + 150;
	sudut15.y = center.y - 60;
	point sudut16;
	sudut16.x = center.x + 120;
	sudut16.y = center.y - 25;
	point sudut17;
	sudut17.x = center.x + 90;
	sudut17.y = center.y + 25;
	point sudut18;
	sudut18.x = center.x + 120;
	sudut18.y = center.y + 60;
	point sudut19;
	sudut19.x = center.x + 150;
	sudut19.y = center.y + 60;
	point sudut20;
	sudut20.x = center.x + 120;
	sudut20.y = center.y + 25;
